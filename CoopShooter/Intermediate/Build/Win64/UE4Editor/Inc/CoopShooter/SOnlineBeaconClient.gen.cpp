...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics
	{
		struct _Script_CoopShooter_eventLobbyUpdated_Parms
		{
			FCoopShooterLobbyInfo FOnLobbyUpdated;
		};
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_FOnLobbyUpdated;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::NewProp_FOnLobbyUpdated = { "FOnLobbyUpdated", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_CoopShooter_eventLobbyUpdated_Parms, FOnLobbyUpdated), Z_Construct_UScriptStruct_FCoopShooterLobbyInfo, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::NewProp_FOnLobbyUpdated,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/SOnlineBeaconClient.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_CoopShooter, nullptr, "LobbyUpdated__DelegateSignature", nullptr, nullptr, sizeof(_Script_CoopShooter_eventLobbyUpdated_Parms), Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature_Statics::FuncParams);
		}
	...
	DEFINE_FUNCTION(ASOnlineBeaconClient::execClient_OnLobbyUpdated)
	{
		P_GET_STRUCT(FCoopShooterLobbyInfo,Z_Param_LobbyInfo);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Client_OnLobbyUpdated_Implementation(Z_Param_LobbyInfo);
		P_NATIVE_END;
	}
	...
	static FName NAME_ASOnlineBeaconClient_Client_OnLobbyUpdated = FName(TEXT("Client_OnLobbyUpdated"));
	void ASOnlineBeaconClient::Client_OnLobbyUpdated(FCoopShooterLobbyInfo LobbyInfo)
	{
		SOnlineBeaconClient_eventClient_OnLobbyUpdated_Parms Parms;
		Parms.LobbyInfo=LobbyInfo;
		ProcessEvent(FindFunctionChecked(NAME_ASOnlineBeaconClient_Client_OnLobbyUpdated),&Parms);
	}
	void ASOnlineBeaconClient::StaticRegisterNativesASOnlineBeaconClient()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "Client_OnLobbyUpdated", &ASOnlineBeaconClient::execClient_OnLobbyUpdated },
	...
	struct Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics
	{
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_LobbyInfo;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::NewProp_LobbyInfo = { "LobbyInfo", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SOnlineBeaconClient_eventClient_OnLobbyUpdated_Parms, LobbyInfo), Z_Construct_UScriptStruct_FCoopShooterLobbyInfo, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::NewProp_LobbyInfo,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/SOnlineBeaconClient.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASOnlineBeaconClient, nullptr, "Client_OnLobbyUpdated", nullptr, nullptr, sizeof(SOnlineBeaconClient_eventClient_OnLobbyUpdated_Parms), Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x01020CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FOnLobbyUpdated_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_FOnLobbyUpdated;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASOnlineBeaconClient_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASOnlineBeaconClient_Client_OnLobbyUpdated, "Client_OnLobbyUpdated" }, // 1771015435
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASOnlineBeaconClient_Statics::NewProp_FOnLobbyUpdated_MetaData[] = {
		{ "ModuleRelativePath", "Public/SOnlineBeaconClient.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ASOnlineBeaconClient_Statics::NewProp_FOnLobbyUpdated = { "FOnLobbyUpdated", nullptr, (EPropertyFlags)0x0020080010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASOnlineBeaconClient, FOnLobbyUpdated), Z_Construct_UDelegateFunction_CoopShooter_LobbyUpdated__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ASOnlineBeaconClient_Statics::NewProp_FOnLobbyUpdated_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASOnlineBeaconClient_Statics::NewProp_FOnLobbyUpdated_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASOnlineBeaconClient_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASOnlineBeaconClient_Statics::NewProp_FOnLobbyUpdated,
	...
	IMPLEMENT_CLASS(ASOnlineBeaconClient, 2008954535);
