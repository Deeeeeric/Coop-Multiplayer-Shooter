...
public: \
	DECLARE_CLASS(AMainMenuGMB, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/CoopShooter"), NO_API) \
...
#define CoopShooter_Source_CoopShooter_Public_MainMenuGMB_h_19_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AMainMenuGMB); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AMainMenuGMB); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AMainMenuGMB(AMainMenuGMB&&); \
	NO_API AMainMenuGMB(const AMainMenuGMB&); \
public:
...
template<> COOPSHOOTER_API UClass* StaticClass<class AMainMenuGMB>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID CoopShooter_Source_CoopShooter_Public_MainMenuGMB_h
